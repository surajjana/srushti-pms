...
if((int)$row["rights"] != 3){
	...
	$sql = "SELECT client_id,name FROM client_log WHERE approval_status=1";
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12 text-center">
                    <h2 class="section-heading">Client Master</h2>
                    <hr class="primary">
                </div>
            </div>
        </div>
                    ...
                    <tbody>
                        <?php  
                            while ($row = mysql_fetch_array($retval, MYSQL_ASSOC)) {
                                echo '<tr><td>'.$row["client_id"].'</td><td>'.$row["name"].'</td><td><a href="client_edit.php?cid='.$row["client_id"].'">Edit</a></td><td><a href="client_delete.php?cid='.$row["client_id"].'">Delete</a></td></tr>';
                            }
                        ?>
                    </tbody>
                </table>
