<?php  
	...
	if($po_amount_pay > $po_balance){
		$state = 1;
	}else{
		$res = $po_balance - $po_amount_pay;
		$sql = "update po_log set po_balance='".$res."',modified_by='".$_SESSION["pms_user"]."',time_modified='".(string)time()."' where po_id=".$po_id;
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12 text-center">
                    <h2 class="section-heading"><?php if($state){echo 'Invalid Amount';}else{echo 'PO Payment Done';} ?></h2>
                    <hr class="primary">
                </div>
            </div>
        </div>
