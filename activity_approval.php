<?php  
    ...
    $sql = "SELECT activity_id,name,added_by FROM activity_log WHERE approval_status=0";
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12 text-center">
                    <h2 class="section-heading">Activity Approval</h2>
                    <hr class="primary">
                </div>
            </div>
        </div>
                    ...
                    <tbody>
                        <?php  
                            while ($row = mysql_fetch_array($retval, MYSQL_ASSOC)) {
                                echo '<tr><td>'.$row["activity_id"].'</td><td>'.$row["name"].'</td><td>'.ucfirst($row["added_by"]).'</td><td><a href="approve_activity.php?cid='.$row["activity_id"].'">Approve</a></td></tr>';
                            }
                        ?>
                    </tbody>
                </table>
