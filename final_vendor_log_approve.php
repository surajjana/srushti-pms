...
$sql_rights = "update vendor_log set approved_by='".$_SESSION["pms_user"]."',time_approved='".(string)time()."',approval_status=1 where vendor_id='".$vendor_id."'";
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12 text-center">
                    <h2 class="section-heading">Vendor ID : <?php echo $vendor_id; ?> Approved!!</h2>
                </div>
            </div>
        </div>
    </section>
