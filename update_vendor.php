...
$sql_insert = "update vendor_log set vendor_grp='".$vendor_grp."',name='".$name."',address='".$address.
              "',city='".$city."',state='".$state."',office_phn='".$office_phn."',mobile='".$mobile."',fax='".$fax."',email='".$email."',contact_person='".$contact_person.
              "',contact_no='".$contact_no."',website='".$website."',pan='".$pan."',tin='".$tin."',cst='".$cst."',ecc='".$ecc."',service_tax_no='".$service_tax_no.
              "',bank_name='".$bank_name."',account_no='".$account_no."',bank_branch='".$bank_branch."',ifsc='".$ifsc."' where vendor_id='".$vendor_id."'";
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12 text-center">
                    <h2 class="section-heading">Vendor Log Sheet Updated!!</h2>
                </div>
            </div>
        </div>
    </section>
