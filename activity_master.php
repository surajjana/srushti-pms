...
if((int)$row["rights"] != 2){
	...
	$sql = "SELECT activity_id,name FROM activity_log WHERE approval_status=1";
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12 text-center">
                    <h2 class="section-heading">Activity Master</h2>
                    <hr class="primary">
                </div>
            </div>
        </div>
                    ...
                    <tbody>
                        <?php  
                            while ($row = mysql_fetch_array($retval, MYSQL_ASSOC)) {
                                echo '<tr><td>'.$row["activity_id"].'</td><td>'.$row["name"].'</td><td><a href="activity_edit.php?cid='.$row["activity_id"].'">Edit</a></td><td><a href="activity_delete.php?cid='.$row["activity_id"].'">Delete</a></td></tr>';
                            }
                        ?>
                    </tbody>
                </table>
