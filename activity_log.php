            ...
            <div class="row">
                ...
                <form action="insert_activity.php" method="post">
                    ...
                    <div class="control-group form-group">
                        <div class="controls">
                            <label>From Date <span style="color:red;">*</span> :</label>
                            <input type="text" class="form-control" name="fromDate" placeholder="dd/mm/yyyy" required data-validation-required-message="Please enter the value .">
                        </div>
                    </div>
                    <div class="control-group form-group">
                        <div class="controls">
                            <label>To Date <span style="color:red;">*</span> :</label>
                            <input type="text" class="form-control" name="toDate" placeholder="dd/mm/yyyy" required data-validation-required-message="Please enter the value .">
                        </div>
                    </div>
                    <div class="control-group form-group">
                        <div class="controls">
                    ...
                    <div class="control-group form-group">
                        <div class="controls">
                            ...
                            <input type="text" class="form-control" name="activity_name" id="" required data-validation-required-message="Please enter the value.">
                        </div>
                    </div>
                    <div class="control-group form-group">
                        <div class="controls">
                            <label>Venue <span style="color:red;">*</span> :</label>
                            <input type="text" class="form-control" name="venue" id="" required data-validation-required-message="Please enter the venue.">
                        </div>
                    </div>
                    <div class="control-group form-group">
                        <div class="controls">
