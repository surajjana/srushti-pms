    ...
    <section id="services">
        ...
        <div class="container">
            <div class="row">
                ...
                <form action="update_pay.php" method="get">
                    <input type="hidden" name="po_id" value='<?php echo $po_id; ?>'>
                    <input type="hidden" name="po_amount" value='<?php echo $row["po_amount"]; ?>'>
                    <input type="hidden" name="po_balance" value='<?php echo $row["po_balance"]; ?>'>
                    <div class="control-group form-group">
                        <div class="controls">
                            <label>Enter Amount <span style="color:red;">*</span> :</label>
                            <input type="text" class="form-control" name="po_amount_pay" required data-validation-required-message="Please enter the value ." >
                        </div>
                    </div>
