...
$sql_rights = "update client_log set approved_by='".$_SESSION["pms_user"]."',time_approved='".(string)time()."',approval_status=1 where client_id='".$client_id."'";
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12 text-center">
                    <h2 class="section-heading">Client ID : <?php echo $client_id; ?> Approved!!</h2>
                </div>
            </div>
        </div>
    </section>
