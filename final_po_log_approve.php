...
$sql_rights = "update po_log set approved_by='".$_SESSION["pms_user"]."',time_approved='".(string)time()."',approval_status=1 where po_id='".$po_id."'";
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12 text-center">
                    <h2 class="section-heading">PO Approved!!</h2>
                </div>
            </div>
        </div>
    </section>
